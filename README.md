...
Для решения задачи программсит мог бы определить форму входа, как форму посылающую AJAX запрос ```remote: true```
...
2. Средстово формирования JSON структур
...
На стороне сервера JODY обеспечивается JBuilder'ом. Он используется для того, что бы аккуратно формировать ответы сервера с заданной стурктурой.
...
Главные ожаидания от систем которые хотят использовать JODY следующие
...
Написание JODY посредника - задача довольно простая. Формирование соглашений - процесс требующий вовлечения большого количества людей и обзора хотя бы нескольких удачных практик на крупных проектах и веделение из них рационального зерна.
